odoo.define('payment_conekta_oxoo.post_processing', require => {
    'use strict';
    ...
    paymentPostProcessing.include({
        ...
        processPolledData: function (display_values_list) {
            ...
            if (display_values_list.length > 0 && ['conekta_oxxo','conekta_spei'].indexOf(display_values_list[0].provider_code) >= 0) {
